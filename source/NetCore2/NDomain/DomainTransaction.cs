...
/// <summary>
    ...
    {
        static AsyncLocal<DomainTransaction> transactionContext = new AsyncLocal<DomainTransaction>();
        // TODO: rename to MessageContextScope

        public DomainTransactionScope(string transactionId, string correlationId, int retryCount)
        {
            transactionContext.Value = new DomainTransaction(transactionId, correlationId, retryCount);
        }
    ...
    public class DomainTransaction
    {
        ...
        public static DomainTransaction Current
        {
            get
            {
                return transactionContext.Value;
            }
        }
    }
}
